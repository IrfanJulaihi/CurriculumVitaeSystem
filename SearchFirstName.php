...
$query_Recordset1 = "SELECT * FROM `self-information` WHERE `First Name` = '$colname_Recordset1'";
...
where `First Name` LIKE '$colname_Recordset1%'";
...
$query_Recordset2 = sprintf("SELECT * FROM `self-information` WHERE `First Name` = '$colname_Recordset2%\'", GetSQLValueString($colname_Recordset2, "text"));
