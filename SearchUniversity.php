...
$query_Recordset1 = "SELECT * FROM qualification WHERE `University` = '$colname_Recordset1'";
...
where `University` LIKE '$colname_Recordset1%'";
...
$query_Recordset2 = sprintf("SELECT * FROM qualification WHERE `University` = '$colname_Recordset2'", GetSQLValueString($colname_Recordset2, "text"));
