...
$query_Recordset1 = "SELECT * FROM `experience` WHERE `Area Of Expertise` = '$colname_Recordset1'";
...
ON qualification.`identification number`=experience.`Identification Number`
where `Area Of Expertise` LIKE '$colname_Recordset1%'";
...
$query_Recordset2 = sprintf("SELECT * FROM `experience` WHERE `Area Of Expertise` = '$colname_Recordset2'", GetSQLValueString($colname_Recordset2, "text"));
...
<table id="customers" width="200" border="1" align="center">
  ...
  ?>
   <tr>
    ...
    <td>
	<a href="Detailinfo.php?value1=
	<?php echo $row_Recordset3['Identification Number']; ?>"><?php echo $row_Recordset3['Identification Number']; ?>
	
    <td><?php echo $row_Recordset3['Last Name']; ?></td>
    ...
    <td><?php echo $row_Recordset3['Marital Status']; ?></td>
     <td><?php echo $row_Recordset3['Area of Expertise']; ?></td>
  <?php 
