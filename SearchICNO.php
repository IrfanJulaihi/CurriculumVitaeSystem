...
$query_Recordset1 = "SELECT * FROM `self-information` WHERE `Identification Number` = '$colname_Recordset1'";
...
where qualification.`Identification Number` LIKE '$colname_Recordset1%'";
...
$totalRows_Recordset3 = mysql_num_rows($Recordset1);
...
$query_Recordset2 = sprintf("SELECT * FROM `self-information` WHERE `Identification Number`= '$colname_Recordset2%\'", GetSQLValueString($colname_Recordset2, "text"));
